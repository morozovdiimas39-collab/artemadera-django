...
urlpatterns = [
    ...
    path("otdelka/", RedirectView.as_view(url="/otdelochnye-raboty", permanent=True)),
    path("otdelka", RedirectView.as_view(url="/otdelochnye-raboty", permanent=True)),
    path("otdelka/shlifovka/srybi/", RedirectView.as_view(url="/otdelka/shlifovka/sruba", permanent=True)),
    path("otdelka/shlifovka/srybi", RedirectView.as_view(url="/otdelka/shlifovka/sruba", permanent=True)),
    path("otdelka/shlifovka/bani-i-sauny/", RedirectView.as_view(url="/shlifovka", permanent=True)),
    path("otdelka/shlifovka/bani-i-sauny", RedirectView.as_view(url="/shlifovka", permanent=True)),
    path("otdelka/shlifovka/konsyerzhnaya/", RedirectView.as_view(url="/shlifovka", permanent=True)),
    path("otdelka/shlifovka/konsyerzhnaya", RedirectView.as_view(url="/shlifovka", permanent=True)),
    path("blog/kak-sdelat-teplyye-shov-v-derevyannom-dome/", RedirectView.as_view(url="/blog/chto-takoe-teplyy-shov/", permanent=True)),
    path("blog/kak-sdelat-teplyye-shov-v-derevyannom-dome", RedirectView.as_view(url="/blog/chto-takoe-teplyy-shov/", permanent=True)),
