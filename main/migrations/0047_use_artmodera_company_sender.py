...
def use_artmodera_company_sender(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("main", "0046_restore_working_email_sender"),
    ]

    operations = [
        migrations.RunPython(use_artmodera_company_sender, migrations.RunPython.noop),
    ]
