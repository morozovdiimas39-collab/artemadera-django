...
def generalize_first_two_steps(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("main", "0024_work_process_steps_short_balance"),
    ]

    operations = [
        migrations.RunPython(generalize_first_two_steps, migrations.RunPython.noop),
    ]
