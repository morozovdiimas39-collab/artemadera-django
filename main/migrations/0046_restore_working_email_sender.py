...
WORKING_EMAIL = "morozov.diimas39@yandex.ru"


def restore_working_email_sender(apps, schema_editor):
    LeadEmailSettings = apps.get_model("main", "LeadEmailSettings")
    cfg, _ = LeadEmailSettings.objects.get_or_create(pk=1)
    cfg.smtp_login = WORKING_EMAIL
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("main", "0045_backfill_missing_crm_deals"),
    ]

    operations = [
        migrations.RunPython(restore_working_email_sender, migrations.RunPython.noop),
    ]
